 ...
 * @author Gabriel
 */
public class VentanaJuegoSU extends javax.swing.JFrame {

    /**
     * Creates new form VentanaJuegoSU
     */
    public VentanaJuegoSU() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaJuegoSU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaJuegoSU().setVisible(true);
            }
        });
    }
